...
//For loop targets the number in the array and then adds the number each time until the loop is completed.
var sum = 0;
...
// For loop to calculate the total change in profit throughout the months.
...
//Calculates the average of the changes by dividing the total change by one less than the number of months.
var averagechange = Math.round(totalChange / (finances.length - 1));
console.log("Average change is: $ " + averagechange);

//Caculates the greatest increase in profits (date and difference in the amounts) over the entire period.
...
//For loop iterates over the array and calcuates the decrease in profits.
